...
const Navbar = () => {
    ...
    return (
        <div className='fixed top-0 max-w-full container flex justify-between border-2 border-primary text-primary z-10 bg-black h-14 sm:h-20 dark:text-white py-3 sm:py-7 px-8 sm:px-12 mb-2 mb-white'>
